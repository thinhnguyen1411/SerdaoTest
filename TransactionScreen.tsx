...
const TransactionScreen = ({ navigation }) => {
  ...
  useEffect(() => {
    ...
    const fullName = selectedBeneficiary.firstName + " " + selectedBeneficiary.lastName;
     setName(fullName);
  ...
  return (
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
      ...
      />
      <Button title="Select beneficiary" onPress={() => navigation.navigate('BeneficiaryList')} />
      <Button title="Submit Transaction" color="#FF0000" onPress={handleTransaction} />
    </View>
  );
};
